  ...
  return (
    <div className="container mx-auto px-4 py-16">
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <PremiumButton
              ...
              processingText={t('contact.form.buttons.sending')}
      ...
      <div className="mb-16">
        ...
        <div className="rounded-xl overflow-hidden h-96 bg-neutral-200 dark:bg-neutral-700 shadow-lg">
          <LeafletMap
            center={[10.8231, 106.6297]} // Ho Chi Minh City coordinates [lat, lng]
            zoom={15}
            markerTitle="BadmintonShop Store"
            markerAddress="123 Commerce Street, Suite 500, Ho Chi Minh City, Vietnam"
            markerPhone="+84 (028) 123-4567"
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            {
              questionKey: 'contact.faq.items.hours.question',
              answerKey: 'contact.faq.items.hours.answer',
            },
            {
              questionKey: 'contact.faq.items.tracking.question',
              answerKey: 'contact.faq.items.tracking.answer',
            },
            {
              questionKey: 'contact.faq.items.returns.question',
              answerKey: 'contact.faq.items.returns.answer',
            },
            {
              questionKey: 'contact.faq.items.shipping.question',
              answerKey: 'contact.faq.items.shipping.answer',
            },
          ].map((faq, index) => (
            <div
              key={index}
