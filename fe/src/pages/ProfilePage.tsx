    ...
    try {
      ...
      if (formData.currentPassword && formData.newPassword) {
        ...
        dispatch(
          addNotification({
            type: 'success',
            message: t('profile.messages.passwordChanged'),
            duration: 3000,
          })
        );
      }
      ...
      dispatch(
        addNotification({
          type: 'success',
          message: t('profile.messages.profileUpdated'),
          duration: 3000,
        })
      );
      ...
      dispatch(
        addNotification({
          type: 'error',
          message: error.data?.message || t('profile.messages.updateFailed'),
          duration: 5000,
        })
      );
    }
                  ...
                  <>
                    ...
                    <div className="flex justify-end space-x-4 mt-8">
                      ...
                      <PremiumButton
                        ...
                        processingText={t('profile.buttons.saving')}
