                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200">
                          {order.items.length}{' '}
                          {order.items.length === 1 ? t('orders.items_one', { count: order.items.length }) : t('orders.items_other', { count: order.items.length })}
                        </p>
                    ...
                    <div className="mt-4 pt-4 border-t border-neutral-200 dark:border-neutral-700">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-sm">
                        ...
                        {order.estimatedDelivery && (
                          <div>
                            <span className="text-neutral-500 dark:text-neutral-400">
                              {t('orders.details.estimatedDelivery')}:{' '}
                            </span>
                            <span className="font-medium text-neutral-800 dark:text-neutral-200">
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center gap-4 mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                                    <span>{t('orders.details.quantity')}: {item.quantity}</span>
                                    <span>
                                      {t('orders.details.price')}: {formatCurrency(item.price)}
                                    </span>
                                  </div>
                                </div>
                                <div className="text-right">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-neutral-600 dark:text-neutral-400 space-y-1">
                            ...
                            {order.shippingPhone && (
                              <p>{t('orders.details.phone')}: {order.shippingPhone}</p>
                            )}
                          </div>
                        </div>
