...
const DealsPage: React.FC = () => {
  ...
  const sortOptions = [
    { value: 'discount_desc', label: t('deals.sort.options.discountDesc') },
    { value: 'price_asc', label: t('deals.sort.options.priceAsc') },
    { value: 'price_desc', label: t('deals.sort.options.priceDesc') },
    { value: 'newest', label: t('deals.sort.options.newest') },
  ];
        ...
        <div className="mb-8 text-center">
          <p className="text-neutral-600 dark:text-neutral-400 text-lg">
            {formattedProducts.length > 0
              ? t('deals.pageDescription.withProducts', { count: formattedProducts.length })
              : t('deals.pageDescription.default')}
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="w-full md:w-48">
            <Select
              ...
              placeholder={t('deals.sort.placeholder')}
            />
          </div>
        </div>
