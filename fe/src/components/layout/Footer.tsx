          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {['facebook', 'twitter', 'instagram', 'youtube'].map((social) => (
                ...
                >
                  <span className="sr-only">{t(`footer.company.socialMedia.${social}`)}</span>
                  <svg
                    className="h-6 w-6"
                    fill="currentColor"
                    viewBox="0 0 24 24"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { key: 'newArrivals', path: '/new-arrivals' },
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { key: 'faqs', path: '/faqs' },
                { key: 'shippingReturns', path: '/shipping-returns' },
                { key: 'orderTracking', path: '/track-order' },
                { key: 'privacyPolicy', path: '/privacy-policy' },
                { key: 'termsConditions', path: '/terms' },
              ].map((link) => (
                <li key={link.key}>
                  <Link
                    to={link.path}
                    className="text-neutral-700 dark:text-neutral-300 hover:text-primary-500 dark:hover:text-primary-400 transition-colors"
                  >
                    {t(`footer.customerService.${link.key}`)}
                  </Link>
                </li>
              ))}
            </ul>
        ...
        <div className="border-t border-neutral-200 dark:border-neutral-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center flex-wrap justify-center gap-4">
            ...
            <img
              ...
              alt={t('footer.payment.momo')}
              className="h-5 object-contain"
            />
            <img
              src="/images/payment-icons/zalopay.png"
              alt={t('footer.payment.zaloPay')}
              className="h-5 object-contain"
            />
          </div>
        </div>
